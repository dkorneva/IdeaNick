...
export const winstonLogger = winston.createLogger({
  ...
  format: winston.format.combine(
    ...
    winston.format.errors({ stack: true }), // хранить стек ошибки - порядок файлов. которые были вызваны до воспроизведения ошибки
    winston.format.json() // хранить в формате json
  ),
