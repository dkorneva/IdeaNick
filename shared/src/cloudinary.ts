...
export const cloudinaryUploadTypes = {
  ...
  // satisfies проверяет, что данный тип соответствует указанному и максимально подробно описывает тип
...
export const getAvatarUrl = (
  ...
  publicId
    ...
    : getCloudinaryUploadUrl('v1787085436/avatars/xly6l2bb7edrz2h9yfas', 'avatar', preset)
